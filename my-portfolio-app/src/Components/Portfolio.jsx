    ...
    <div>
      <div className="container">
        <div className="portfolio-content">
          ...
          <p>
            All my projects are open source, which i would be placing the github
            repository link down below.
          </p>
        </div>
      </div>
      <div className="container">
            ...
            <div className="card text-bg-dark">
              <div className="card-body">
                ...
                <p className="card-text">
                  A clone of Google keep app built usin Reactjs, Html, Css, and
                  JavaScript.
                </p>
                <Link
          ...
          <div className="col-sm-6">
            <div className="card text-bg-dark">
              <div className="card-body">
                ...
                <p className="card-text">
                  A Nodejs web-app that authenticates students before writing an
                  examination.
                </p>
                <Link
